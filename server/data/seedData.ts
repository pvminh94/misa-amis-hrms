...
export const initialEmployees: Employee[] = [
  ...
  },
  {
    ...
    salary: {
      ...
      dependents: 1,
      taxCode: '8091234503',
      insuranceBookNumber: '7912345603'
    },
    contracts: [],
    workHistory: [],
    rewardsDisciplines: [],
  ...
  },
  {
    ...
    phone: '0987654321',
    email: 'landm@amis.vn',
    address: 'Thăng Long Number One, Cầu Giấy, Hà Nội',
    hometown: 'Nam Định',
    ...
    salary: {
      ...
      dependents: 1,
      taxCode: '8091234504',
      insuranceBookNumber: '7912345604'
    },
    contracts: [],
    workHistory: [],
    rewardsDisciplines: [],
  ...
  },
  {
    ...
    dob: '1984-08-30',
    idCard: '001184005678',
    idCardDate: '2021-11-20',
    idCardPlace: 'Cục Cảnh sát QLHC về TTXH',
    phone: '0934567890',
    email: 'duchm@amis.vn',
    address: 'Royal City, Thanh Xuân, Hà Nội',
    hometown: 'Hải Phòng',
    education: 'Thạc sĩ Tài chính Kế toán - ĐH Kinh Tế Quốc Dân',
    ...
    salary: {
      ...
      dependents: 2,
      taxCode: '8091234505',
      insuranceBookNumber: '7912345605'
    },
    contracts: [],
    workHistory: [],
    rewardsDisciplines: [],
  ...
  },
  {
    ...
    dob: '1993-06-18',
    idCard: '001193006789',
    idCardDate: '2022-07-22',
    idCardPlace: 'Cục Cảnh sát QLHC về TTXH',
    phone: '0945678901',
    email: 'longlh@amis.vn',
    ...
    joinDate: '2021-04-01',
    contractType: 'Hợp đồng lao động 3 năm',
    contractStartDate: '2021-04-01',
    contractEndDate: '2024-04-01',
    status: 'active',
    bankAccount: {
      bankName: 'MB Bank',
      accountNumber: '0880100678901',
      branch: 'Cầu Giấy'
    },
    salary: {
      baseSalary: 28000000,
      allowanceResponsibility: 3000000,
      allowanceLunch: 1500000,
      allowanceGas: 1000000,
      dependents: 0,
      taxCode: '8091234506',
      insuranceBookNumber: '7912345606'
    },
    contracts: [],
    workHistory: [],
    rewardsDisciplines: [],
